    ...
    return (
        <div className=" px-4 py-2">
            ...
            <div className="flex gap-4 align-bottom items-end  mt-1">
                ...
                <Button onClick={()=>handleSearch({theme:selectedValueThemeQuestions,country:selectedValueCountryQuestions})}  size={'sm'} className="  text-sm border-blue-500 bg-white border flex gap-2 hover:bg-blue-300 hover:text-blue-50 hover:border-white text-blue-500 "> <Search size={16} /><p>Filtrar</p> </Button>
            </div>
        </div>
    );
};
